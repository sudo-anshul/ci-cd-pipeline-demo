...
- GitHub Actions (for CI/CD and Source code Management)
...
We used Firebase Hosting provides fast and secure hosting for your web app, static and dynamic content, and microservices.
Although we didn't used microservices for this project.
